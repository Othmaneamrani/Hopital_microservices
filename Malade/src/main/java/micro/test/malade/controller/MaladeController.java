...
public class MaladeController {
    ...
    @GetMapping("/setchambre")
    public MaladeRepresentation setChambre(@RequestParam int idChambre , @RequestParam int idMalade){
        return iMaladeService.setChambre(idChambre,idMalade);
    }
